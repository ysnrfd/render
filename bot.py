...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        # 🧠 فراخوانی مدل هوش مصنوعی (بدون استریم)
...
if __name__ == "__main__":
    ...
    # 🔁 این خط برای جلوگیری از خاتمه زودهنگام اضافه شده
    # بدون این خط، برنامه بلافاصله خاتمه می‌یابد
    import asyncio
